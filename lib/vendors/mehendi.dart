...
class Mehendi extends StatefulWidget {
  const Mehendi({super.key});

  @override
  State<Mehendi> createState() => _MehendiState();
}

class _MehendiState extends State<Mehendi> {
  List<VendorsData> Vendors = [
    VendorsData(
      price: 1500,
      Name: 'Jeetu Mehendi Arts',
