...
class Caterings extends StatefulWidget {
  const Caterings({super.key});

  @override
  State<Caterings> createState() => _CateringsState();
}

class _CateringsState extends State<Caterings> {
  List<VendorsData> Vendors = [
    ...
    VendorsData(
      price: 300,
      Name: 'Nalabhagam Caterers',
      imageURL: 'asset/caterings1.jpg',
      Count: "50 - 500",
      rating: 4.0
    ),
    VendorsData(
