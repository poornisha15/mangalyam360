...
class _JewelleryState extends State<Jewellery> {
  List<VendorsData> Vendors = [
    VendorsData(
      price: 2000,
      Name: 'Attrangi Designs',
      imageURL: 'asset/jewellery1.jpg',
      Count: "200 - 1000",
      rating: 4.5
    ),
    VendorsData(
      price: 3000,
      Name: 'Aaghna Fashions',
      imageURL: 'asset/jewellery2.jpg',
      Count: "50 - 500",
      rating: 4.0
    ),
    VendorsData(
      price: 1000,
      Name: "TB Jewellery" ,
      imageURL: 'asset/jewellery3.jpg',
      Count: "1000 - 2000",
      rating: 4.8
    ),
    VendorsData(
      price: 1000,
      Name: 'WedMe Jewellery',
      imageURL: 'asset/jewellery4.jpg',
      Count: "200 - 500",
      rating: 4.9
    ),
  ];
